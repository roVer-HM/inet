...
class INET_API MediumCanvasVisualizer : public MediumVisualizerBase
{
  ...
  protected:
     ...
     */
    std::map<const physicallayer::IRadio *, cFigure *, physicallayer::CmpIRadioPtrById> signalDepartureFigures;
    /**
     * The list of reception figures.
     */
    std::map<const physicallayer::IRadio *, cFigure *, physicallayer::CmpIRadioPtrById> signalArrivalFigures;
    /**
     * The propagating signal figures.
     */
    std::map<const physicallayer::ITransmission *, cFigure *, physicallayer::CmpITransmissionPtrById> signalFigures;
    /**
